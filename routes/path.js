...
//user
router.get('/users', requireLogin, adminCheck(db, User), (req, res) => getUsers(req, res, db, User));
router.get('/users/:user_id', requireLogin, adminCheck(db, User), (req, res) => getUser(req, res, db, User));
...
router.delete('/users/:user_id', requireLogin, adminCheck(db, User), (req, res) => handleDelete(req, res, db, User));
